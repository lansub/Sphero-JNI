...
class Sphero
{
	public:
		...
		* @brief : Wake Sphero
		*
		* @return 0 if all wake commands are succesfully send, -1 otherwise
		*/
		int wake();
		...
		*/
        ...
        void rollToPosition(spherocoord_t x, spherocoord_t y, 
             spherocoord_t actualX,spherocoord_t actualY, uint8_t initSpeed = 90);
	...
	private:
		...
		static const size_t MAX_CONNECT_ATTEMPT = 1;
		bool _connected;
